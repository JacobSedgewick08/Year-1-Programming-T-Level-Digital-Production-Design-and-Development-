...
import matplotlib.pyplot as plt
 ...
 ### Trends/ Patterns USD + GBP ###

data = pd.read_csv("Task4a_data.csv")

Pounds_to_Dollars = data["GBP - USD"]
dates = data["Date"]
def Pounds_to_Dollars():
    Pounds_to_Dollars = data["GBP - USD"]
    plt.plot(dates, Pounds_to_Dollars)
    plt.grid()
    plt.xticks(rotation=45)
    plt.xlabel("Date")
    plt.ylabel("Pounds to Dollars conversion rate")
    plt.show()

def Dollars_to_Pounds():
    Dollars_to_Pounds = data["USD - GBP"]
    plt.plot(dates, Dollars_to_Pounds)
    plt.grid()
    plt.xticks(rotation=45)
    plt.xlabel("Date")
    plt.ylabel("Dollars to Pounds Conversion Rate")
    plt.show()

#def conversion_line_chart():
    #currency_change = currency 
    #plt.plot(dates, currency_change)
    #plt.grid()
    #plt.xticks(rotation=45)
    #plt.xlabel("Date")
    #plt.ylabel(currency)
...
def menu():
    ...
    while flag:
        ...
        print("7. Pound Sterling (GBP) to US Dollars (USD)")
        print("8. US Dollars (USD) to Pound Sterling (GBP)")
        print("")
        print("######################################################")
